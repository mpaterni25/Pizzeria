...
public class Pedido extends AppCompatActivity {
    ...
    public void guardar(View v){
        ...
        if(validarTodo()){
            tamaño = sptamaño.getAdapter().toString();
            ...
            p = new Pizza(foto,tamaño,bordequeso,pedido,ingredientes,precio);
    ...
    public void buscar(View v){
        ...
        if(p!=null)
            ...
            sptamaño.setSelection(t);
                if(p.getBordequeso().equalsIgnoreCase(getResources().getString(R.string.si)))rSi.setChecked(true);
                else rNO.setChecked(true);

                ingredientess = p.getIngredientes();
                if(ingredientess.contains(getResources().getString(R.string.Champiñon))) chkChampi.setChecked(true);
                if(ingredientess.contains(getResources().getString(R.string.Salami))) chkSalami.setChecked(true);
                if(ingredientess.contains(getResources().getString(R.string.Piña))) chkPiña.setChecked(true);
                if(ingredientess.contains(getResources().getString(R.string.Chorizo))) chkChorizo.setChecked(true);
                if(ingredientess.contains(getResources().getString(R.string.Pepperoni))) chkPeperoni.setChecked(true);
                if(ingredientess.contains(getResources().getString(R.string.Jamon))) chkJamon.setChecked(true);
                if(ingredientess.contains(getResources().getString(R.string.Pollo))) chkPollo.setChecked(true);
    }
